...
<form class="form common-table" method="post" action="edit_check.php">
  <table>
    <tr>
    ...
    <tr>
      ...
      <td>
        <input id="postal1" type="text" name="postal1" maxlength="3" value="<?php echo $user->getPostal1() ?>">-<input id="postal2" type="text" name="postal2" maxlength="4" value="<?php echo $user->getPostal2() ?>">
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <div class="radio-wrap clearfix">
          <label class="radio-label"><input type="radio" name="gender" value="1"<?php if ($user->getGender() === '1') echo ' checked' ?>>男性</label>
          <label class="radio-label"><input type="radio" name="gender" value="2"<?php if ($user->getGender() === '2') echo ' checked' ?>>女性</label>
        </div>
      </td>
    </tr>
    <tr>
